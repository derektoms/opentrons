...
p10.distribute(
    ['2'],
    plate_source.wells(0),
plate_mapped.wells(['A4']).bottom(2)
    )
...
p10.distribute(
    ['8'],
    plate_source.wells(1),
plate_mapped.wells(['B1']).bottom(2)
    )
...
p10.distribute(
    ['8'],
    plate_source.wells(2),
plate_mapped.wells(['D10']).bottom(2)
    )
...
p10.distribute(
    ['4.8'],
    plate_source.wells(3),
plate_mapped.wells(['F9']).bottom(2)
    )
...
p10.distribute(
    ['6.87'],
    plate_source.wells(4),
plate_mapped.wells(['H1']).bottom(2)
    )